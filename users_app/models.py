...
class BusinessInfo(models.Model):
    business_user = models.OneToOneField(UserProfile, on_delete=models.CASCADE)
    ...
    def __str__(self):
        """
        Returns the string representation of the BusinessInfo, showing the ID and username.
        """
        return f"({self.id}) {self.business_user.user.username}"
