...
def fill_database():
    ...
    offer_details = [
        OfferDetails.objects.create(offer=offers[0], offer_type='basic', price_cents=20000, features=comm_feat['web_design'], delivery_time_in_days=3),
        OfferDetails.objects.create(offer=offers[0], offer_type='standard', price_cents=30000, features=comm_feat['web_design_standard'], delivery_time_in_days=7),
        OfferDetails.objects.create(offer=offers[0], offer_type='premium', price_cents=50000, features=comm_feat['web_design_premium'], delivery_time_in_days=21),
        OfferDetails.objects.create(offer=offers[1], offer_type='basic', price_cents=15000, features=comm_feat['seo_basic'], delivery_time_in_days=3),
        OfferDetails.objects.create(offer=offers[1], offer_type='standard', price_cents=25000, features=comm_feat['seo_standard'], delivery_time_in_days=7),
        OfferDetails.objects.create(offer=offers[1], offer_type='premium', price_cents=40000, features=comm_feat['seo_premium'], delivery_time_in_days=21),
        OfferDetails.objects.create(offer=offers[2], offer_type='basic', price_cents=10000, features=comm_feat['social_media_basic'], delivery_time_in_days=3),
        OfferDetails.objects.create(offer=offers[2], offer_type='standard', price_cents=20000, features=comm_feat['social_media_standard'], delivery_time_in_days=7),
        OfferDetails.objects.create(offer=offers[2], offer_type='premium', price_cents=30000, features=comm_feat['social_media_premium'], delivery_time_in_days=21),
        OfferDetails.objects.create(offer=offers[3], offer_type='basic', price_cents=22000, features=comm_feat['web_design'], delivery_time_in_days=3),
        OfferDetails.objects.create(offer=offers[3], offer_type='standard', price_cents=33000, features=comm_feat['web_design_standard'], delivery_time_in_days=7),
        OfferDetails.objects.create(offer=offers[3], offer_type='premium', price_cents=53000, features=comm_feat['web_design_premium'], delivery_time_in_days=21),
        OfferDetails.objects.create(offer=offers[4], offer_type='basic', price_cents=17000, features=comm_feat['seo_basic'], delivery_time_in_days=3),
        OfferDetails.objects.create(offer=offers[4], offer_type='standard', price_cents=28000, features=comm_feat['seo_standard'], delivery_time_in_days=7),
        OfferDetails.objects.create(offer=offers[4], offer_type='premium', price_cents=44000, features=comm_feat['seo_premium'], delivery_time_in_days=21),
        OfferDetails.objects.create(offer=offers[5], offer_type='basic', price_cents=12000, features=comm_feat['social_media_basic'], delivery_time_in_days=3),
        OfferDetails.objects.create(offer=offers[5], offer_type='standard', price_cents=22000, features=comm_feat['social_media_standard'], delivery_time_in_days=7),
        OfferDetails.objects.create(offer=offers[5], offer_type='premium', price_cents=35000, features=comm_feat['social_media_premium'], delivery_time_in_days=21),
        OfferDetails.objects.create(offer=offers[6], offer_type='basic', price_cents=25000, features=comm_feat['web_design'], delivery_time_in_days=3),
        OfferDetails.objects.create(offer=offers[6], offer_type='standard', price_cents=38000, features=comm_feat['web_design_standard'], delivery_time_in_days=7),
        OfferDetails.objects.create(offer=offers[6], offer_type='premium', price_cents=60000, features=comm_feat['web_design_premium'], delivery_time_in_days=21),
        OfferDetails.objects.create(offer=offers[7], offer_type='basic', price_cents=13000, features=comm_feat['seo_basic'], delivery_time_in_days=3),
        OfferDetails.objects.create(offer=offers[7], offer_type='standard', price_cents=22000, features=comm_feat['seo_standard'], delivery_time_in_days=7),
        OfferDetails.objects.create(offer=offers[7], offer_type='premium', price_cents=36000, features=comm_feat['seo_premium'], delivery_time_in_days=21),
        OfferDetails.objects.create(offer=offers[8], offer_type='basic', price_cents=15000, features=comm_feat['social_media_basic'], delivery_time_in_days=3),
        OfferDetails.objects.create(offer=offers[8], offer_type='standard', price_cents=26000, features=comm_feat['social_media_standard'], delivery_time_in_days=7),
        OfferDetails.objects.create(offer=offers[8], offer_type='premium', price_cents=41000, features=comm_feat['social_media_premium'], delivery_time_in_days=21),
        OfferDetails.objects.create(offer=offers[9], offer_type='basic', price_cents=30000, features=comm_feat['web_design'], delivery_time_in_days=3),
        OfferDetails.objects.create(offer=offers[9], offer_type='standard', price_cents=43000, features=comm_feat['web_design_standard'], delivery_time_in_days=7),
        OfferDetails.objects.create(offer=offers[9], offer_type='premium', price_cents=65000, features=comm_feat['web_design_premium'], delivery_time_in_days=21),
        OfferDetails.objects.create(offer=offers[10], offer_type='basic', price_cents=20000, features=comm_feat['seo_basic'], delivery_time_in_days=3),
        OfferDetails.objects.create(offer=offers[10], offer_type='standard', price_cents=30000, features=comm_feat['seo_standard'], delivery_time_in_days=7),
        OfferDetails.objects.create(offer=offers[10], offer_type='premium', price_cents=47000, features=comm_feat['seo_premium'], delivery_time_in_days=21),
        OfferDetails.objects.create(offer=offers[11], offer_type='basic', price_cents=14000, features=comm_feat['social_media_basic'], delivery_time_in_days=3),
        OfferDetails.objects.create(offer=offers[11], offer_type='standard', price_cents=25000, features=comm_feat['social_media_standard'], delivery_time_in_days=7),
        OfferDetails.objects.create(offer=offers[11], offer_type='premium', price_cents=40000, features=comm_feat['social_media_premium'], delivery_time_in_days=21),
        OfferDetails.objects.create(offer=offers[12], offer_type='basic', price_cents=25000, features=comm_feat['web_design'], delivery_time_in_days=3),
        OfferDetails.objects.create(offer=offers[12], offer_type='standard', price_cents=38000, features=comm_feat['web_design_standard'], delivery_time_in_days=7),
        OfferDetails.objects.create(offer=offers[12], offer_type='premium', price_cents=60000, features=comm_feat['web_design_premium'], delivery_time_in_days=21),
        OfferDetails.objects.create(offer=offers[13], offer_type='basic', price_cents=250000, features=comm_feat['web_design'], delivery_time_in_days=3),
        OfferDetails.objects.create(offer=offers[13], offer_type='standard', price_cents=450000, features=comm_feat['web_design_standard'], delivery_time_in_days=7),
        OfferDetails.objects.create(offer=offers[13], offer_type='premium', price_cents=750000, features=comm_feat['web_design_premium'], delivery_time_in_days=21),
        OfferDetails.objects.create(offer=offers[14], offer_type='basic', price_cents=200000, features=comm_feat['seo_basic'], delivery_time_in_days=3),
        OfferDetails.objects.create(offer=offers[14], offer_type='standard', price_cents=400000, features=comm_feat['seo_standard'], delivery_time_in_days=7),
        OfferDetails.objects.create(offer=offers[14], offer_type='premium', price_cents=600000, features=comm_feat['seo_premium'], delivery_time_in_days=21),
        OfferDetails.objects.create(offer=offers[15], offer_type='basic', price_cents=150000, features=comm_feat['social_media_basic'], delivery_time_in_days=3),
        OfferDetails.objects.create(offer=offers[15], offer_type='standard', price_cents=350000, features=comm_feat['social_media_standard'], delivery_time_in_days=7),
        OfferDetails.objects.create(offer=offers[15], offer_type='premium', price_cents=550000, features=comm_feat['social_media_premium'], delivery_time_in_days=21),
        OfferDetails.objects.create(offer=offers[16], offer_type='basic', price_cents=300000, features=comm_feat['web_design'], delivery_time_in_days=3),
        OfferDetails.objects.create(offer=offers[16], offer_type='standard', price_cents=500000, features=comm_feat['web_design_standard'], delivery_time_in_days=7),
        OfferDetails.objects.create(offer=offers[16], offer_type='premium', price_cents=700000, features=comm_feat['web_design_premium'], delivery_time_in_days=21),
    ]
